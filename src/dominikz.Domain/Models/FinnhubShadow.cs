...
public class FinnhubShadow
{
    ...
    public decimal[] Quarters { get; set; } = Array.Empty<decimal>();
    public decimal Surprise { get; set; }
    public decimal SurprisePercent { get; set; }
    public bool PeakFlag { get; set; }
    public bool IncreaseFlag { get; set; }
    public bool ChartFlag { get; set; }
