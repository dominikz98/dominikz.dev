...
{
    public class CodeSyntaxStyleSheet : IStyleSheet
    {
        private static readonly Color DullRed = new(163, 21, 21);
        private readonly CSSTheme _theme;

        public CodeSyntaxStyleSheet(CSSTheme theme)
        {
            _theme = theme;
        }
        ...
        public StyleDictionary Styles
            => new()
            {
                ...
                {
                    Foreground = _theme.GetColor(ThemeColor.Secondary),
                    Background = _theme.GetColor(ThemeColor.Surface),
                ...
                {
                    //Foreground = Color.Blue,
                    Foreground = new Color(62, 156, 202),
